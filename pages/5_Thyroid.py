...
Query_Hypo = st.selectbox("Query Hypothyroid", ["No", "Yes"])
Query_Hyper = st.selectbox("Query Hyperthyroid", ["No", "Yes"])
...
Query_Hypo = 1 if Query_Hypo == "Yes" else 0
Query_Hyper = 1 if Query_Hyper == "Yes" else 0
